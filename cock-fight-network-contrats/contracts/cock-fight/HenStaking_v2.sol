...
contract HenStakingV2 is ERC721, ReentrancyGuard {
    ...
    uint256 public maxReward = 18250 * 1e18; // 총 리워드
    ...
    uint256 public rewardPerStakingAllowed = 50 * 1e18; // stakingAllowedTimestamp 당 보상
    ...
    ) ERC721("CFN Hen Staking Card V2 ", "CFNHSCV2") {
